...
class Partita(models.Model):
    ...
    squadra_casa = models.ForeignKey('Squadra', models.DO_NOTHING, db_column='squadra_casa')
    squadra_ospite = models.ForeignKey('Squadra', models.DO_NOTHING, db_column='squadra_ospite')
